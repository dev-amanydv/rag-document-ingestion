...
class Review(TypedDict):
    key_themes: Annotated[List[str], 'list of key themes discussed in review']
    pros: Annotated[Optional[List[str]], "List of short statements showign the pros of product from the review"]
    cons: Annotated[Optional[List[str]], "List of short statements showign the cons of product from the review"]
    summary: Annotated[str, "A breif summary of the review"]
    sentiment: Annotated[Literal["pos", "neg"], "A one word sentiment like neg for negative, pos for positive"]
